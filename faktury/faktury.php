...
echo '<br/>';
echo '<form action="wybierznabywce.php" method="POST" >';
...
?>
<form action="nowafaktura.php" method="POST" />
...
<div style="width: auto; height: 220px; overflow: scroll;">
<?php
for ($x=0; $x<30; $x++)
{
	?>
<p>Nazwa<input type="text" name="produkt[]" value="" size="40"/>
		JM<input type="text" name="jm[]" value="" size="4"/>
		Ilość<input type="text" name="ilosc[]" value="" size="4"/>
		Cena<input type="text" name="cena[]" value="" size="7"/>
		Stawka VAT: <select name="vat[]">
